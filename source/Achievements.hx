...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Freaky on a Friday Night",	"Jogue em uma sexta-feira... à noite.",							'friday_night_play',	 true],
		["Você foi muito BEN!",		"Vença a Week Woody sem perder.",				'week7_nomiss',			 false],
		["Isso foi muito legal, bro!",				"Vença a Restaurant Week sem perder.",				'week2_nomiss',			 false],
		["Mas que funkin de desastre!",	"Complete uma música com uma classificação inferior a 20%.",	'ur_bad',				false],
		...
		["Hiperativo",					"Termine uma música sem mostrar o Idle.",				'hype',					false],
		["Apenas nós dois",			"Termine uma música pressionando apenas duas teclas.",				false],
		["Jogador de torradeira",				"Você já tentou rodar o jogo em uma torradeira?",		'toastie',				false],
		["Secreto",					"Vença o estágio \"Test\" do Chart Editor.",	'debugger',				 true]
	];
