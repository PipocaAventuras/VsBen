...
//this code is from vs dave guys!!!!!
...
class MusicPlayerState extends MusicBeatState
{
    ...
    override function create()
    {
		...
		iconP2 = new HealthIcon("ben", false);
		iconP2.y = healthBar.y - (iconP2.height / 2);
		add(iconP2);

        barText = new FlxText(healthBarBG.x + healthBarBG.width / 2 - 150, healthBarBG.y + healthBarBG.height + 5, 0, "", 20);
		barText.setFormat(Paths.font("funkin.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
