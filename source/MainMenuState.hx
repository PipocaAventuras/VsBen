...
class MainMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['story_mode', 'freeplay', #if ACHIEVEMENTS_ALLOWED 'awards', 'ost', 'credits', #end 'options'];
	...
	override function create()
	{
		...
		magenta = new FlxSprite(0).loadGraphic(Paths.image('nothing'));
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://discord.gg/uTkdNt3WBX');
				}
				else
				{
					selectedSomethin = true;
